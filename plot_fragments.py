...
def get_fragments():
    ...
    return(fragment_ids,fragment_times,fragment_pos,fragment_geo_pos,fragment_pos_err)


if __name__ == "__main__":
    fragment_ids,fragment_times,fragment_pos,fragment_geo_pos,fragment_pos_err=get_fragments()
