...
# plot it to make sure things make sense
if False:
...
# to do a better job, we would need to piece together fragments and their parent fragments.
# say, we start with z, trace back along the parent fragments until fragment 1 or 2 to create a 
